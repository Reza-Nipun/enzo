                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="inputName" class="form-control" name="sub_category_name" value="{{old('sub_category_name')}}">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="inputDescription" class="form-control" name="sub_category_description" value="{{old('sub_category_description')}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
