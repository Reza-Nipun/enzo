...
<head>
    ...
    <title>{{ isset($title) ? $title : 'ENZO | Dashboard' }}</title>
...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        {{--<a href="{{ url('/') }}" class="brand-link" target="_blank">--}}
            {{--<img src="{{ asset('img/enzo_logo.jpeg') }}" alt="ENZO" class="brand-image elevation-3">--}}
            {{--<span class="brand-text font-weight-light">ENZO</span>--}}
        {{--</a>--}}
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item {{ request()->is('category') || request()->is('sub_category') || request()->is('product') ? 'menu-open' : ''}}">
                        <a href="#" class="nav-link {{ request()->is('category') || request()->is('sub_category') || request()->is('product') ? 'active' : ''}}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('sub_category.index') }}" class="nav-link {{ request()->is('sub_category') ? 'active' : ''}}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Sub Category</p>
                                </a>
                            </li>
...
<!-- /.content-wrapper -->
    <footer class="main-footer">
        <strong>Copyright &copy; 2021 <a href="{{ url('/') }}" target="_blank">ENZO.FASHION</a>.</strong>
        All rights reserved.
